...
.index-aside {
	...
	top: 64px;
	left: 0;
	background: url(http://localhost:8080/onlineOrder/file/949c4a27b0d84ab88f99681fc52ae618.png) no-repeat center top,url(http://localhost:8080/onlineOrder/file/1057db36d2aa4bd4b375aa0ccb752a40.png) repeat-x left 20px,linear-gradient(180deg, rgba(124,160,101,1) 0%, rgba(124,160,101,1) 100%),#f6f6f6;
	width: 240px;
	border-color: #d9d9d9;
